...
export default function ContactPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              <div className="p-6 rounded-xl bg-surface-dark border border-surface-dark-lighter">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  We are open daily from 5:00 AM to 10:00 PM to fit your busy
                  schedule.
                </p>
              </div>
              <div className="p-6 rounded-xl bg-surface-dark border border-surface-dark-lighter">
      ...
      <a
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white p-3 pr-5 rounded-full shadow-lg hover:-translate-y-1 transition-transform"
